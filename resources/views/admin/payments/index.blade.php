        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="{{route('shoes.payments.index')}}" class="btn btn-primary" style="margin-bottom: 15px">Thêm thương hiệu</a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    @foreach($allPayment as $value)
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td style="text-align: center;">
                                                <a href="{{route('shoes.payments.index',$value->id_brand)}}" class="btn btn-primary">Sửa</a>
                                                <a href="{{route('shoes.payments.index',$value->id_brand)}}" onclick="return xacnhaxoa('Bạn có chắc muốn xóa !')" class="btn btn-danger">Xóa</a>
                                            </td> 
                                        </tr>
                                    @endforeach
                                    </tbody>
